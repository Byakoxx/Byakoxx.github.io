...
if(b>a&&b>30){$PBJQ(".Mrphs-topHeader").addClass("moving");
...
}else{if(b>40){$PBJQ(".Mrphs-topHeader").removeClass("moving");
...
$PBJQ(".fa fa-user all-sites-icon login-view").addClass("log-view");
